...
// metadata
metadata {
	definition (name: "Aeon HEM Gen5(zwave plus)", namespace: "DuncanIdahoCT", author: "Dillon A. Miller", vid: "generic-switch-power-energy") {	// 20190424: added ', vid: "generic-switch-power-energy"'
...
def zwaveEvent(physicalgraph.zwave.commands.meterv3.MeterReport cmd) {
    ...
    switch(cmd.scale) {
        case 0: //kWh
						...
						sendEvent(name: "cost", value: costDisplay, unit: "", descriptionText: "Display Cost: \$${costDisplay}")	//20190424 bugfix
...
def configure() {
	...
	//zwave.configurationV1.configurationSet(parameterNumber: 255, size: 1, scaledConfigurationValue: 1),
		...
		// Set parameter 2 to 1 for positive and negative values
